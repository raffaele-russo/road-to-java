...
//
// NOTE: this file does NOT compile yet. Solution 5 (Resource) is a compile-time error
...
//
// Run once you think you're done:  java -ea 00-cpp-vs-java/Solution.java
public class Solution {
    ...
    static boolean compareValues(int a, int b) {
        Integer boxedA = a;
        Integer boxedB = b;
        return boxedA.equals(boxedB); // BUG: reference comparison
    }
    ...
    static int doubleIt(int x) {
        return 2 * x; // BUG: doesn't double anything
    }
    ...
    interface Config {
        int MAX_ATTEMPTS = 3; // TODO: wrong value
    }
